...
add_action('widgets_init', function(){return register_widget("wplook_projects_widget");});
class wplook_projects_widget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
	 		...
	 		__('WPlook Projects', 'benevolence-wpl'), // Name
			array( 'description' => __( 'A widget for displaying Projects', 'benevolence-wpl' ), )
		);
	}
	...
	public function form( $instance ) {
		if ( $instance ) {
			...
			$title = __( 'Projects', 'benevolence-wpl' );
		}
		...
		?>
			...
			<p>
				<label for="<?php echo $this->get_field_id('nr_posts'); ?>"> <?php _e('Number of projects:', 'benevolence-wpl'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('Number of projects you want to display', 'benevolence-wpl'); ?></p>
			</p>

			<p>
				<label for="<?php echo $this->get_field_id('read_more_link'); ?>"> <?php _e('URL to all projects:', 'benevolence-wpl'); ?> </label>
				...
				<p style="font-size: 10px; color: #999; margin: -10px 0 0 0px; padding: 0px;"> <?php _e('View all projects URL', 'benevolence-wpl'); ?></p>
			</p>
