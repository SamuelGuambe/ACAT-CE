...
<div id="main" class="site-main container_12">
	<div id="primary" class="content-area ml <?php if ( $page_width != 'off' ) { echo 'grid_9'; } else { echo 'grid_12'; } ?>">
		...
		<?php $args = array( 'post_type' => 'post_ministries','post_status' => array( 'publish', 'private' ), 'posts_per_page' => ot_get_option('wpl_ministries_per_page'), 'paged'=> $paged); ?>
